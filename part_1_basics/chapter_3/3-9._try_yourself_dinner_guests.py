...
message_number_of_guests = "There is " + str(len(guest_list)) + " guests invited to tonight's dinner."
	# Defines variable with len() function and quotes
	# len() function  counts the ammount in the list
	# str() is very important to tell Python that the number is a string, not an index
