...
message_more_seats = \
	"\nDear guests, I found a bigger table, so more people will be invited to \
	today's dinner. The invitations will be printed for \
	everyone in few minutes."
...
message_cannot_come = \
	"\nDear " + cannot_come.title() + \
	", I am very sorry to inform you, that due to the problems with the \
	delayed table, I must cancell your invitation for today's dinner. \
	I hope to make up for this inconvenience very soon."
	# message is defined including the variable cannt_come
...
message_invitation = \
	"\nDear " + guest_index.title() + \
	", despite the changes, I still would like to invite you for a dinner at \
	my place, tonight. Hope to see you there."
...
message_invitation = \
	"\nDear " + guest_index.title() + \
	", despite the changes, I still would like to invite you for a dinner \
	at my place, tonight. Hope to see you there."
