...
#
#
# WE WANT TO KEEP THEM IN BOTH FOLDERS
# Will use a slice to copy the list, while keeping the original
...
print(sent_messages)
# We can see that they had a reversed order as pop() starts at the end
